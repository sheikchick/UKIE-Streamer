const { SlippiGame, characters: characterUtil } = require('@slippi/slippi-js');
const _ = require('lodash');

function slpGetWinners(game) {
...
function isProperGame(game) {
    ...
    if (game.settings.players.length != 2 && game.settings.players.length != 4) {
        return false;
    }
